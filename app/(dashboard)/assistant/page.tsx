...
const smartSuggestions = [
  ...
  {
    icon: Users,
    title: "5 new leads need follow-up.",
    desc: "Reach out to convert them.",
    color: "bg-emerald-600/20 text-emerald-400",
  },
  {
    icon: TrendingUp,
    title: "Your revenue is up 18% this month.",
    desc: "View detailed analytics.",
    color: "bg-teal-600/20 text-teal-400",
  },
  {
    icon: Gift,
    title: "You have 2 upcoming appointments.",
...
export default function AssistantPage() {
  ...
  const getConversationKey = (conversation: Conversation, index = 0) =>
    conversation._id ||
  ...
  if (chatOpen) {
    return (
      <div className="dashboard-page flex flex-col">
        <Header
          title="Kora Chat"
          subtitle="Continue your Kora Assistant conversation."
        />
        <div className="dashboard-content flex min-h-0 flex-col">
          <Card className="flex min-h-0 flex-1 flex-col overflow-hidden border-blue-600/20 bg-[radial-gradient(circle_at_18%_0%,rgba(34,211,238,0.08),transparent_32%),linear-gradient(180deg,#091526,#071321)] shadow-[inset_0_1px_0_rgba(255,255,255,0.04)]">
            <CardHeader className="shrink-0 border-b border-[#1e2d40] pb-4">
              <div className="flex items-center justify-between gap-3">
                <div className="flex min-w-0 items-center gap-3">
                  ...
                  <CardTitle className="truncate text-lg">Kora Chat</CardTitle>
                </div>
                <Button
                  variant="outline"
            ...
            <CardContent className="grid min-h-0 flex-1 grid-cols-1 p-0 xl:grid-cols-[minmax(0,1fr)_340px] 2xl:grid-cols-[minmax(0,1fr)_380px]">
              ...
              <aside className="hidden min-h-0 flex-col border-l border-[#1e2d40] bg-[#071321]/70 xl:flex">
                <div className="shrink-0 border-b border-[#1e2d40] px-5 py-4">
                  <h2 className="truncate text-base font-semibold text-white">
                    Recent Conversations
                  </h2>
                </div>
                <div className="scrollbar-blue min-h-0 flex-1 overflow-y-auto p-3">
                  <div className="space-y-1">
                    {recentConversations.map((conversation, index) => {
                      ...
                      const active = activeConversationKey === conversationKey;
                      ...
                      return (
                        <button
                          ...
                          className={`group flex min-h-12 w-full items-center gap-3 rounded-lg px-3 py-2.5 text-left transition-colors disabled:cursor-not-allowed disabled:opacity-60 ${
                            active
                              ? "bg-[#12315a] text-white"
                              : "text-gray-200 hover:bg-[#0d1a2d]"
                          }`}
                        >
                          <MessageCircle
                          ...
                          <div className="min-w-0 flex-1">
                            ...
                            <p
                              className={`mt-0.5 truncate text-[11px] ${
                                active ? "text-cyan-100/70" : "text-gray-500"
                              }`}
                            >
                              {formatConversationDate(conversation) || "Recent"}
                            </p>
                          </div>
                        </button>
                      );
              ...
              <div className="flex h-full flex-col gap-5 p-5 sm:flex-row sm:items-center">
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <p className="mt-3 max-w-xl text-sm leading-6 text-gray-300">
                    ...
                    business, answer questions, automate tasks and provide
                    insights.
                  </p>
          ...
          <div className="dashboard-secondary flex min-h-0 flex-col gap-3 overflow-hidden">
            ...
            <Card className="flex min-h-0 flex-1 flex-col bg-[#091526]">
              ...
              <CardContent className="scrollbar-blue min-h-0 flex-1 space-y-2 overflow-y-auto pr-3">
                {smartSuggestions.map((suggestion) => (
                  ...
                  >
                    <div
                      className={`flex h-10 w-10 shrink-0 items-center justify-center rounded-xl ${suggestion.color}`}
                    >
            ...
            <Card className="shrink-0 bg-[#091526]">
              <CardContent className="p-5">
                ...
                <button
                  type="button"
                  className="mt-4 flex w-full items-center justify-between rounded-xl bg-[#0d1a2d] px-4 py-3 text-sm text-gray-200 transition-colors hover:bg-[#1e2d40]"
                >
